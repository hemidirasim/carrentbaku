...
const translations: Record<Language, Record<string, string>> = {
  az: {
    ...
    'hero.headline.part2': 'ölkəni kəşf edin',
    'hero.description': 'Unudulmaz səyahətlərə çıxın və bizim xüsusi rahat avtomobillərimiz ilə ölkəni misilsiz rahatlıq və üslubda kəşf edin.',
