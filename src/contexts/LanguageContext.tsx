...
const translations: Record<Language, Record<string, string>> = {
  az: {
    ...
    'services.longTerm.desc': 'Convenient and cost-effective solutions for those needing a vehicle for an extended period, with discounted rates.',
    'services.luxury.title': 'Luxury Car Rentals',
    'services.luxury.desc': 'Drive in style with our selection of high-end vehicles, perfect for special occasions or executive travel.',
