...
const translations: Record<Language, Record<string, string>> = {
  az: {
    ...
    'hero.headline.part2': 'dünyanı kəşf edin',
    'hero.description': 'Unudulmaz səyahətlərə çıxın və bizim xüsusi rahat avtomobillərimiz ilə dünyanı misilsiz rahatlıq və üslubda kəşf edin.',
  ...
  ru: {
    ...
    'hero.description': 'Отправляйтесь в незабываемые приключения и открывайте мир в непревзойдённом комфорте и стиле с нашим парком исключительно комфортных автомобилей.',
  ...
  en: {
    ...
    'hero.description': 'Embark on unforgettable adventures and discover the world in unparalleled comfort and style with our fleet of exceptionally comfortable cars.',
  ...
  ar: {
    ...
    'hero.description': 'انطلق في مغامرات لا تُنسى واكتشف العالم براحة لا مثيل لها وأناقة مع أسطولنا من السيارات المريحة بشكل استثنائي.',
