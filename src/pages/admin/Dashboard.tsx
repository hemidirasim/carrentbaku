        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                ...
                Məqalələr & Yeniliklər
              </CardTitle>
              <CardDescription>
                Məqalə və xəbər yazılarını idarə edin
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild className="w-full">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Müştəri rəylərini əlavə edin və redaktə edin
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild className="w-full">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Sosial şəbəkələri və əlaqə məlumatlarını idarə edin
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild className="w-full">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                DigitalOcean agenti üçün təlimatları yeniləyin
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild className="w-full">
                <Link to="/admin/agent-config">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Haqqımızda səhifəsinin məzmununu redaktə edin
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button asChild className="w-full">
